...
routerApp.controller('myControl', function($scope){
    $scope.message = 'Mission complete !!!';
...
/*
    function myBubbleChart() {
        ...
        this.buildChart = function(){
            ...
            var node = svg.selectAll(".node")
                .data(bubble.nodes(classes(sampleJson))
                    .filter(function (d) {
                        return !d.children;
                    }))
                .enter().append("g")
    ...
    */
    ...
    /*
    var values1 = [10, 20, 30, 40, 40, 40, 50];
    var config = {
        elementId: '#chart',
        columnsData: 'data',
        columnsData_x: 'data_x',
        value: values1,
        colors: 'color',
        width: 'width',
        height: 'height',
    ...
    var chart = c3.generate({
        ...
        data: {
            ...
            json: {
                'data1': [0, 0, 0, 0, 0, 0, 0],
                'x': ['2016-01-05', '2016-02-08', '2016-03-20', '2016-03-20', '2016-04-01', '2016-05-05', '2016-06-10']
            },
            type: 'scatter',
            colors: function(d) {
                console.log('d:::', d);
...
routerApp.controller("calendarCtrl", function($scope, $filter, $http, $q) {
